...
def __get_version():
    try:
        ...
        genie_directory = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
        pyproject_path = os.path.join(genie_directory, "pyproject.toml")
        try:
            ...
            print("Warning: Failed to extract GenIE version.", file=sys.stderr)
            return "UNKNOWN"
