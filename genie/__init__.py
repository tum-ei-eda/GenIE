...
the GenIE infrastructure.

The various elements of GenIE are organized into modules. You may import them
...
.. comment
    .. data:: discovered_plugins
        ...
        A dictionary of detected GenIE plugins, with the module name as a key and
